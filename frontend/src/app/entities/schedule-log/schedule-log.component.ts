...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/schedule-log'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    ngOnInit() {
        ...
        this.registerChangeInScheduleLogs();
    }
    ...
    registerChangeInScheduleLogs() {
        this.eventSubscriber = this.eventManager.subscribe('scheduleLogListModification', (response) => this.loadAll());
    }
